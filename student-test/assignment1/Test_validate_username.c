...
void test_validate_my_username()
{
    // 1) Call the my_username() function to get your hard-coded username.
    ...
    TEST_ASSERT_EQUAL_STRING_MESSAGE(expected_username, actual_username, "Username from config file does not match expected.");
